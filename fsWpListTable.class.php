...
//        var_dump($this->screen); die;
    ...
    protected function set_pagination_args($args) {
        ...
        if (!headers_sent() && (!defined('DOING_AJAX') || !DOING_AJAX) && $args['total_pages'] > 0 &&
...
/*        if (empty($_REQUEST['s']) && !$this->has_items()) {
        ...
        ?>
        <p class="search-box">
            <input type="hidden" name="page" value="lpMain"/>
    ...
    protected function pagination($which) {
        ...
        $output = '<span class="displaying-num">' .
                  sprintf(_n('%s item', '%s items', $total_items), number_format_i18n($total_items)) . '</span>';
        ...
        if ('bottom' === $which) {
            ...
            $total_pages_before = '<span class="screen-reader-text">' . __('Current Page') .
    ...
    protected function get_primary_column_name() {
        ...
        if (!isset($columns[ $default ])) {
            $default = fs_WP_List_Table::get_default_primary_column_name();
        }
